...
- [MYSQL Injection](#mysql-injection)
  ...
  - [MYSQL Union Based](#mysql-union-based)
    - [Detect columns number](#detect-columns-number)
        - [Using `order by` or `group by`](#using-order-by-or-group-by)
        - [Using `order by` or `group by` Error Based](#using-order-by-or-group-by-error-based)
        - [Using `UNION SELECT` Error Based](#using-union-select-error-based)
        - [Using `LIMIT INTO` Error Based](#using-limit-into-error-based)
        - [Using `SELECT * FROM SOME_EXISTING_TABLE` Error Based](#using-select--from-some_existing_table-error-based)
  ...
  - [MYSQL Blind](#mysql-blind)
    ...
    - [MySQL Blind SQL Injection in ORDER BY clause using a binary query and REGEXP](#mysql-blind-sql-injection-in-order-by-clause-using-a-binary-query-and-regexp)
    - [MySQL Blind SQL Injection binary query using REGEXP.](#mysql-blind-sql-injection-binary-query-using-regexp)
